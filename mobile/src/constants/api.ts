...
export const API_ENDPOINTS = {
  ...
  villageBoundaries: '/api/village-boundaries',
  ...
  householdCollections: (uid: string, limit = 10, offset = 0) =>
    `/api/waste-collections/household/${encodeURIComponent(uid)}?limit=${limit}&offset=${offset}`,
